            ...
            <div class="mt-6 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
                <div class="max-w-3xl space-y-4">
                    <h1 class="text-4xl font-heading text-pondok-primary md:text-5xl">
                        Kegiatan & Pengumuman Pondok Pesantren Nurul Ikhlas
                    </h1>
                    <p class="text-base text-gray-600">
                        Jadwal rutin, program unggulan, serta informasi pendaftaran santri baru yang dirancang untuk
                        mendukung perjalanan tahfidzul Qur’an dan pembinaan karakter santri.
                    </p>
                </div>
                <a id="pendaftaran" href="https://forms.gle/xxxxxx" target="_blank"
        ...
        <div class="mx-auto grid max-w-7xl gap-10 px-6 lg:grid-cols-[1.3fr,1fr] lg:px-10">
            <div class="space-y-5">
                ...
                <div class="rounded-2xl bg-white/10 p-5 text-sm text-pondok-accent">
                    ...
                    <p class="mt-2 leading-relaxed text-pondok-accent/90">{{ $contact['address'] }}</p>
